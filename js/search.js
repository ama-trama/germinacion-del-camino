(function() {
  function displaySearchResults(results, store) {
    ...
    for (var i = 0; i < results.length; i++) {  // Iterate over the results
      ...
      appendString += '<div class="image"><a href="/germinacion-del-camino' + item.url + '"><img src="/germinacion-del-camino/img/' + item.img + '.jpg"></a></div>';
      appendString += '<div class="content"><a href="/germinacion-del-camino' + item.url + '"><h3 class=" header">' + item.title + '</h3></a>';
